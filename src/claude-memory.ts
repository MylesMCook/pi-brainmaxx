...
export type ClaudeMemorySyncResult = {
...
const renderImportedMemory = (sourceFile: string, content: string): string =>
  [
...
const listMemoryFiles = async (memoryDir: string): Promise<string[]> => {
...
export const syncClaudeMemoryImports = async (
  projectRoot: string,
  projectsRoot?: string,
